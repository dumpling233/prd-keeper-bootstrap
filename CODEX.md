...
`prd-keeper` 是本项目的 PRD 上下文治理流程。Codex 处理非平凡开发任务时必须优先使用 `$prd-keeper`，并先阅读 [.agent/skills/prd-keeper/SKILL.md](.agent/skills/prd-keeper/SKILL.md)、[.agent/skills/prd-keeper/routing.yaml](.agent/skills/prd-keeper/routing.yaml) 和 [docs/prd/README.md](docs/prd/README.md)。
...
本文件只作为 Codex 薄入口。详细规则以 `.agent/skills/prd-keeper/` 为准。